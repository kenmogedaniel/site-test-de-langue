...
const FEATURES = [
  {
    ...
    titleKey: "en.feat.leconsGuidees",
    descKey: "en.feat.leconsGuidees.desc",
  },
  {
    glyph: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6">
    ...
    titleKey: "en.feat.audio",
    descKey: "en.feat.audio.desc",
  },
  {
    glyph: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6">
    ...
    titleKey: "en.feat.suivi",
    descKey: "en.feat.suivi.desc",
  },
  {
    glyph: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6">
    ...
    titleKey: "en.feat.correction",
    descKey: "en.feat.correction.desc",
  },
];
    ...
    <main>
          ...
          <div className="grid w-full items-center gap-12 lg:grid-cols-[1.2fr_auto]">
            <div className="text-washi drop-shadow-sm">
              ...
              <h1 className="mt-4 font-display text-6xl leading-[1.05] tracking-tight md:text-7xl">
                ...
                <br />
                {t("en.heroTitle2", lang)}
              </h1>
              <p className="mt-5 max-w-lg leading-relaxed text-washi/90">
                {t("en.heroSubtitle", lang)}
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <HeroCta
                  dashboardLabel={t("en.ctaContinue", lang)}
                  guestLabel={t("en.ctaStart", lang)}
      ...
      <section id="lecons" className="scroll-mt-20 bg-white/40 py-20 dark:bg-white/[0.02]">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="font-display text-3xl">{t("en.programTitle", lang)}</h2>
          <p className="mt-2 max-w-xl text-sm leading-relaxed text-sumi/60 dark:text-washi/60">
            {t("en.programSubtitle", lang)}
          </p>
